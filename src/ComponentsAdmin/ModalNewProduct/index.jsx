...
const ModalNewProduct = () => {
    ...
    return (
        <div className={`fixed left-0 top-0 bottom-0 right-0 bg-white bg-opacity-20 duration-200 justify-center items-center overflow-y-auto ${newProduct ? 'flex' : "hidden"}`}>
            <div className="w-1/2 h-2/5 bg-black_modal rounded-xl border-2 border-light_green flex flex-col items-center">
                ...
                <div className='flex w-full h-5/6 items-center justify-between'>
                    <button className='flex w-1/3 h-4/6 bg-red-700  rounded-md text-center justify-center items-center mx-3 text-white font-semibold text-xl hover:bg-red_button' onClick={close}>Cancelar</button>
                    <button className='flex w-1/3 h-4/6 bg-light_green rounded-md text-center justify-center items-center mx-3 hover  text-white font-semibold text-xl hover:bg-green_button' onClick={close}> Confirmar</button>
                </div>
                </div>
            </div>

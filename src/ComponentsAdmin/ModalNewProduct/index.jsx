            ...
            ">
                ...
                '>
                    ...
                    <div className='flex flex-col w-3/5'>
                        ...
                        <input type="text" placeholder='Digite o Preço' className="h-3/6 w-full pl-2 bg-transparent text-grey_text outline-none rounded-lg mb-5 border border-green_pormade
                ...
                '>
                    <button className='flex w-2/5 h-4/5 bg-red-700  rounded-md text-center justify-center items-center  text-white font-semibold text-xl hover:bg-red_button
                        tablet:w-80 tablet:h-2/5
                    ' onClick={close}>Cancelar</button>
                    <button className='flex w-2/5 h-4/5 bg-light_green rounded-md text-center justify-center items-center  hover  text-white font-semibold text-xl hover:bg-green_button
                        tablet:w-80 tablet:h-2/5

...
export default function ProductDetails () {
    ...
    return(
        <div className="w-full h-screen  flex flex-col justify-center items-center almostCellphone:bg-black almostCellphone:py-8">
            ...
            <div className="w-10/12 h-5/6 flex justify-center flex-wrap bg-black border-2 border-light_green rounded-3xl tablet:flex-col tablet:flex-nowrap tablet:items-center tablet:justify-start tablet:pb-10 almostCellphone:h-full overflow-y-scroll pb-8">
